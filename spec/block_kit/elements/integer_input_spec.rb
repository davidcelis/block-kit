...
RSpec.describe BlockKit::Elements::IntegerInput, type: :model do
  ...
  context "attributes" do
    it { is_expected.to have_attribute(:initial_value).with_type(:integer) }
    it { is_expected.to have_attribute(:min_value).with_type(:integer) }
    it { is_expected.to have_attribute(:max_value).with_type(:integer) }
